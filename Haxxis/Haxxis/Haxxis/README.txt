...
- You must create a Windows environment variable called CGC_LOCAL_BUILD_ROOT and set it to the path leading to the build folder that has the HaxxisPackages folder in it.


===================================================
Notes for version 2016.06.02_15.08.01:  A brief tour
